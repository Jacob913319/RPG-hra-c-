...
void vylepseni(){ 
    uroven=((cenazivoty+cenautok+cenabrneni+cenarychlost)/100)/3;
    cout<<"___________________________________________UROVEN: "<<uroven<<" _______________________________________________________\n";
cout<<"|                                                                                                                   | \n";           
cout<<"|                                                                                                                   |\n";
cout<<"|    1    ZIVOTY - - -"<<zivoty<<"----="<<zivoty+5<<"- - - - - - - - - - - -cena:"<<cenazivoty<<"                  |\n";
cout<<"|                                                                                                                   |\n";
cout<<"|___________________________________________________________________________________________________________________|\n";
cout<<"|                                                                                                                   |\n";
cout<<"|                                                                                                                   |\n";
cout<<"|    2    UTOK - - - -"<<utok<<"----="<<utok+3<<"- - - - - - - - - - - - - -cena:"<<cenautok<<"                     |\n";
cout<<"|                                                                                                                   |\n";
cout<<"|___________________________________________________________________________________________________________________|\n";
cout<<"|                                                                                                                   |\n";
cout<<"|                                                                                                                   |\n";
cout<<"|    3    BRNENI- - -"<<brneni<<"----="<<brneni+3<<"- - - - - - - - - - - -cena:"<<cenabrneni<<"                    |\n";
cout<<"|                                                                                                                   |\n";
cout<<"|___________________________________________________________________________________________________________________|\n";
cout<<"|                                                                                                                   |\n";
cout<<"|                                                                                                                   |\n";
cout<<"|    4     RYCHLOST- "<<rychlost<<"----="<<rychlost+3<<"- - - - - - - - - - - -cena:"<<cenarychlost<<"              |\n";
cout<<"|                                                                                                                   |\n";
cout<<"|___________________________________________________________________________________________________________________|\n";
